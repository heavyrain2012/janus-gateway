...
namespace mars{
    namespace stn{
        ...
        const char* keyContentType = "content_type";

        const char* keyDomain = "domain";
        const char* keyToken = "token";
        const char* keyServer = "server";
        const char* keyPort = "port";
        const char* keyPresignedUrl = "presigned_url";
        const char* keyBackupPresignedUrl = "backup_presigned_url";
        ...
        const char* keySum = "sum";
        const char* keyFull = "full";
        ...
        const char* keyRead = "read";
        const char* keyDelivery = "delivery";
        ...
        const char* keyDomainId = "domain_id";
        ...
        const char* keyFrom = "from";

        const char* keyCommercial = "commercial";
        const char* keyCandidate = "candidate";
        const char* keyBackupServer = "backup_server";
        const char* keyBackupPort = "backup_port";

        const char* keyMediaUrl = "media_url";
        const char* keyThumbUrl = "thumb_url";
        const char* keyWidth = "width";
        const char* keyHeight = "height";
        const char* keyFeedId = "feed_id";
        const char* keyCommentId = "comment_id";
        const char* keySender = "sender";
        const char* keyText = "text";
        const char* keyTel = "tel";
        const char* keyMedias = "medias";
        const char* keyMentionedUsers = "mentioned_users";
        const char* keyToUsers = "to_users";
        const char* keyExcludeUsers = "exclude_users";
        const char* keyComments = "comments";
        const char* keyFeeds = "feeds";
        const char* keyReplyTo = "reply_to";
        const char* keyReplyId = "reply_id";
        const char* keyHasMore = "has_more";

        const char* keyBackupUrl = "backup_url";

        const char* keyLastMsg = "last_msg";
        const char* keyConv = "conv";
        const char* keyPersistFlag = "persist_flag";
