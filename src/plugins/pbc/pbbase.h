...
namespace mars{
    namespace stn{
        ...
        extern const char* keyReadTime;
        extern const char* keyRcvdTime;

        extern const char* keySearchableContent;
        extern const char* keyPushContent;
        extern const char* keyPushData;
        extern const char* keyData;
        extern const char* keyMediaType;
        extern const char* keyRemoteMediaUrl;
        extern const char* keyUrl;
        extern const char* keyDownloadCount;
        extern const char* keySize;
        extern const char* keyDt;
        extern const char* keyRecord;
        ...
        extern const char* keySum;
        extern const char* keyFull;
        ...
        extern const char* keyRead;
        extern const char* keyDelivery;
        ...
        extern const char* keyFrom;

        extern const char* keyCommercial;
        extern const char* keyCandidate;
        extern const char* keyBackupServer;
        extern const char* keyBackupPort;

        extern const char* keyMediaUrl;
        extern const char* keyThumbUrl;
        extern const char* keyWidth;
        extern const char* keyHeight;
        extern const char* keyFeedId;
        extern const char* keyCommentId;
        extern const char* keySender;
        extern const char* keyText;
        extern const char* keyTel;
        extern const char* keyMedias;
        extern const char* keyMentionedUsers;
        extern const char* keyToUsers;
        extern const char* keyExcludeUsers;
        extern const char* keyComments;
        extern const char* keyFeeds;
        extern const char* keyReplyTo;
        extern const char* keyReplyId;
        extern const char* keyHasMore;

        extern const char* keyBackupUrl;

        extern const char* keyLastMsg;
        extern const char* keyConv;
        extern const char* keyPersistFlag;
